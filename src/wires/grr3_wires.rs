...
pub fn generate_and_wires(wi: &(BigUint, BigUint), wj: &(BigUint, BigUint), gate_id: &BigUint) -> (BigUint, BigUint) {
    let w0c;
    let w1c;
...
pub fn generate_xor_wires(wi: &(BigUint, BigUint), wj: &(BigUint, BigUint), gate_id: &BigUint) -> (BigUint, BigUint) {
    let w0c;
    let w1c;
    let w00 = get_00_wire(&wi, &wj, gate_id);
