...
pub fn get_xor_tt(w0i: &BigUint, w1i: &BigUint, w0j: &BigUint, w1j: &BigUint, w0o: &BigUint, w1o: &BigUint) -> [(BigUint, BigUint, BigUint); 4] {
    [(w0i.clone(), w0j.clone(), w0o.clone()), (w0i.clone(), w1j.clone(), w1o.clone()), (w1i.clone(), w0j.clone(), w1o.clone()), (w1i.clone(), w1j.clone(), w0o.clone())] // should avoid using clone if wanting performancee
}